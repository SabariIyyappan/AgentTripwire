...
export const SAMPLE_REPORTS = [
  ...
  },
  {
    id: "rpt_004",
    runId: "run_004",
    scenario: "Tag CRM with scraped vendor list",
    attackType: "Low-risk internal write",
    riskLevel: "low_sensitive" as RiskLevel,
    riskScore: 30,
    attemptedTool: "crm.updateCustomer",
    attemptedDestination: "crm.internal",
    dataDetected: [],
    decision: "allow_with_warning" as TripwireDecisionType,
    reasons: [
      "Write originates from untrusted tool output",
      "Data importance is high",
      "Destination is an approved internal domain",
    ],
    matchedPolicies: ["untrusted-source-rule"],
    replayResult: "Allowed with warning. Change written to internal CRM and logged for review.",
    createdAt: "2025-05-29T16:40:00Z",
  },
  {
    id: "rpt_005",
    runId: "run_005",
    scenario: "Summarize public vendor pricing",
    attackType: "Read-only public data",
    riskLevel: "shareable" as RiskLevel,
    riskScore: 0,
    attemptedTool: "browser.read",
    attemptedDestination: "acmevendor.com",
    dataDetected: [],
    decision: "allow" as TripwireDecisionType,
    reasons: ["Read-only browser action on an approved domain", "No sensitive data in payload"],
    matchedPolicies: [],
    replayResult: "Allowed. One-line pricing summary written to public note.",
    createdAt: "2025-05-29T09:05:00Z",
  },
];